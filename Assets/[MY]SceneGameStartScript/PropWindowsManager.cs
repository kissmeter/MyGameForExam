...
public class PropWindowsManager : MonoBehaviour {
    ...
    //}
    //交互上，F瞄准了一把枪
    public void IfFIsToAGun(DataOfGun ThisGun)
    {


    }
    //交互上，G瞄准了一把枪
    public void IfGIsToAGun(DataOfGun ThisGun)
    {


    }
    //如果扔掉手头的枪
    public void IfPickDownAGunFromHand() {
        //判断当前是不是真的拿枪
        //当前使用的枪UseNow
        //Gun_PutOutOneFromHand(int i-1)
        //进行一次刷新

    }
    public void IfPickDownAGunFromBackOrBag() {


    }
    //如果只有to，撞到谁就让谁滚蛋，也并非不可，拥有UI的地方应该有三种或者四种，撞到谁让谁滚蛋是最简单的，先这么搞，剩下的以后再说 
    public void IfUGuiControlAGunToAPlace(DataOfGun ThisGun,int To)
    {
